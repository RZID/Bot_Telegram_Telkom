            ...
            <div class="container">
                <div class="columns is-desktop">
                    <div class="column">
                        ...
                        <p class="subtitle">
                            Berikut adalah data user...
                        </p>
                    </div>
                    <div class="column userplus">
                        <button class="button is-info" data-target="iomodal" onclick="tambahuser()">+ Tambah User</button>
                    </div>
                </div>
                <div class="box is-white">
                    <div class="table-container">
                        <table id="dataPelanggan" class="table table is-striped table is-hoverable" style="width:100%;">
                            ...
                            <tbody>
                                <?php
                                foreach ($dis->db->get("user_images")->result() as $d) { ?>
                                    <tr>
                                        <td class=""></td>
                                        <td><?= $d->nama_user ?></td>
                                        <td><?= $d->email_user ?></td>
                                        <td>
                                            <?php if ($dis->db->get("user_images")->num_rows() > 1) {
                                            ?>
                                                <button class="tag is-danger" onclick="deleteUser('<?= $d->email_user ?>')"><i class="fas fa-trash px-2"></i></button>
                                            <?php } else {
                                                echo "User Tidak Dapat Dihapus!";
                                            } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
